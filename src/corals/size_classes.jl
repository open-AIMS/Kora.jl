...
function bin_edges()::Matrix{Float32}
    m = Matrix{Float32}(undef, 5, 8)
    m[1, :] .= (2.5f0, 7.5f0, 12.5f0, 25.0f0, 50.0f0, 80.0f0, 120.0f0, 160.0f0)
    m[2, :] .= (2.5f0, 7.5f0, 12.5f0, 20.0f0, 30.0f0, 60.0f0, 100.0f0, 150.0f0)
    m[3, :] .= (2.5f0, 7.5f0, 12.5f0, 20.0f0, 30.0f0, 40.0f0, 50.0f0, 60.0f0)
    m[4, :] .= (2.5f0, 5.0f0, 7.5f0, 10.0f0, 20.0f0, 40.0f0, 50.0f0, 100.0f0)
    m[5, :] .= (2.5f0, 5.0f0, 7.5f0, 10.0f0, 20.0f0, 40.0f0, 50.0f0, 100.0f0)
    return m
end
