...
#   recruit_heritability:    f32  offset 1460 (4 bytes)    # Part 14 -- breeder's-equation h²
#   Total: 1464 bytes
#
...
function parse_params(bytes::Vector{UInt8})
    ...
    recruit_heritability = read(io, Float32)
    return (;
        reef_area_m2,
        init_cover_pct,
        deploy_volumes,
